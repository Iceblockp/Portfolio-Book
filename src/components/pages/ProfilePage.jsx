...
import cvForm from "../../assets/img/resume.pdf"
    ...
    <div>
      <div className=" flex flex-col items-center ">
        ...
        <div className=" flex gap-1 ">
          <div className=" w-5 h-5 border border-sky-500 rounded-full flex justify-center items-center ">
            <a
              href="https://www.facebook.com/pyae.nyo.3?mibextid=ZbWKwL"
              target="_blank"
            >
              <svg
                className=" w-3 h-3 fill-sky-500 "
          ...
          <div className=" w-5 h-5 border border-sky-500 rounded-full flex justify-center items-center ">
            <a href="https://github.com/Iceblockp" target="_blank">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className=" w-3 h-3 fill-sky-500 "
                viewBox="0 0 496 512"
          ...
          <div className=" w-5 h-5 border border-sky-500 rounded-full flex justify-center items-center ">
            <a
              href="https://www.linkedin.com/in/pyae-phyo-nyo-0497652a2/"
              target="_blank"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
