...
import { messageSuccess } from "../alert/message-alert";
...
const ContactMe = ({ fourthPageChange }) => {
  ...
  const handleSubmit = (e) => {
    ...
    const mailtoLink = `mailto:phonyo126@gmail.com?subject=${encodeURIComponent(
      subject
    ...
    <div>
      ...
      <div>
        <form className="max-w-sm mx-auto" onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="flex items-center px-2   gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-sky-600 text-white hover:bg-sky-500"
          >
            <span>Send</span>
            <span>
              <svg
